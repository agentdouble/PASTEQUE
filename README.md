...
- En mode tickets, l’UI affiche un indicateur « DeepSearch mode : … » avec variantes aléatoires plus longues, sans répétition de mots, et avec certaines variantes exclues au démarrage.
