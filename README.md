...
- Exemple Airflow: `airflow/dags/radar_regenerate.py` declenche la regen via `POST /api/v1/loop/regenerate` avec auth admin. Variables: `RADAR_API_BASE_URL`, `RADAR_ADMIN_USERNAME`, `RADAR_ADMIN_PASSWORD`, option `RADAR_TABLE_NAME`, `RADAR_TIMEOUT_S`.
