...
- En mode tickets, le panneau « Ticket exploration » affiche l’aperçu des tickets filtrés par les périodes sélectionnées (limite pilotée par `EVIDENCE_LIMIT_DEFAULT` côté backend).
